...
`r htmltools::withTags(br())`
`r htmltools::withTags(br())`
`r emo::ji("hatching_chick")` .medium-font[Became interested in better biology education]]
...
.pull-right-low[
`r htmltools::withTags(img(src = "css/images/figs/cause-venn-diagram.png", width = "300px"))`]
