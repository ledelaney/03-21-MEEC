...
`r htmltools::HTML('<span id="demo">10 </span> Seconds')`
`r htmltools::HTML('<button type="button" class="btn btn-outline-info" onclick="myTimerObj.start()">Start counter</button>')`
